 ...
 *
 *  If you wish to tick the refresh rate of the desired video mode in addition
 ...
 *  is specified.
 *
 *  If you only wish to tick the resolution of a full screen window or the
 ...
 *  affected by any resizing or mode switching, although you may need to tick
